...
func TestLinuxKit_NewLinuxKitManagerWithHypervisor_Good(t *testing.T) {
	auditTarget := "NewLinuxKitManagerWithHypervisor"
	auditVariant := "Good"
...
func TestLinuxKitManager_Run_UnsupportedFormat_Bad(t *testing.T) {
	auditTarget := "Run UnsupportedFormat"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_List_VerifiesRunningStatus_Good(t *testing.T) {
	auditTarget := "List VerifiesRunningStatus"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestFollowReader_Read_ContextCancel_Good(t *testing.T) {
	auditTarget := "Read ContextCancel"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_Run_BuildCommandError_Bad(t *testing.T) {
	auditTarget := "Run BuildCommandError"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
	...
	mock.buildErr = core.NewError("test error")
...
func TestLinuxKitManager_Stop_ContextCancelled_Good(t *testing.T) {
	auditTarget := "Stop ContextCancelled"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestIsProcessRunning_NonexistentProcess_Bad(t *testing.T) {
	auditTarget := "NonexistentProcess"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_Run_WithPortsAndVolumes_Good(t *testing.T) {
	auditTarget := "Run WithPortsAndVolumes"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_Run_ForegroundStartError_Bad(t *testing.T) {
	auditTarget := "Run ForegroundStartError"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_Run_ForegroundWithError_Good(t *testing.T) {
	auditTarget := "Run ForegroundWithError"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKitManager_Stop_ProcessExitedWhileRunning_Good(t *testing.T) {
	auditTarget := "Stop ProcessExitedWhileRunning"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_NewLinuxKitManager_Good(t *testing.T) {
	auditTarget := "NewLinuxKitManager"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_Run_Good(t *testing.T) {
	auditTarget := "LinuxKitManager Run"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_Stop_Good(t *testing.T) {
	auditTarget := "LinuxKitManager Stop"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_List_Good(t *testing.T) {
	auditTarget := "LinuxKitManager List"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_Logs_Good(t *testing.T) {
	auditTarget := "LinuxKitManager Logs"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_followreader_Close_Good(t *testing.T) {
	auditTarget := "followreader Close"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_Exec_Good(t *testing.T) {
	auditTarget := "LinuxKitManager Exec"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxKit_LinuxKitManager_Hypervisor_Good(t *testing.T) {
	auditTarget := "LinuxKitManager Hypervisor"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestLinuxkit_NewLinuxKitManager_Good(t *testing.T) {
	...
	targetSymbol := "NewLinuxKitManager"
	variantCase := "Good"
...
func TestLinuxkit_NewLinuxKitManagerWithHypervisor_Good(t *testing.T) {
	...
	targetSymbol := "NewLinuxKitManagerWithHypervisor"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_Run_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager Run"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_Stop_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager Stop"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_List_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager List"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_Logs_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager Logs"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_Exec_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager Exec"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_State_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager State"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestLinuxkit_LinuxKitManager_Hypervisor_Good(t *testing.T) {
	...
	targetSymbol := "LinuxKitManager Hypervisor"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
