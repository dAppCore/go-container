...
func TestCDNSource_LatestVersion_NoManifest_Bad(t *testing.T) {
	auditTarget := "LatestVersion NoManifest"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDNSource_LatestVersion_ServerError_Bad(t *testing.T) {
	auditTarget := "LatestVersion ServerError"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDNSource_Download_NoProgress_Good(t *testing.T) {
	auditTarget := "Download NoProgress"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDNSource_Download_LargeFile_Good(t *testing.T) {
	auditTarget := "Download LargeFile"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDNSource_Download_HTTPErrorCodes_Bad(t *testing.T) {
	auditTarget := "Download HTTPErrorCodes"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDNSource_Download_CreatesDestDir_Good(t *testing.T) {
	auditTarget := "Download CreatesDestDir"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDN_CDNSource_Available_Good(t *testing.T) {
	auditTarget := "CDNSource Available"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDN_CDNSource_LatestVersion_Good(t *testing.T) {
	auditTarget := "CDNSource LatestVersion"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCDN_CDNSource_Download_Good(t *testing.T) {
	auditTarget := "CDNSource Download"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestCdn_CDNSource_Available_Good(t *testing.T) {
	...
	targetSymbol := "CDNSource Available"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestCdn_CDNSource_LatestVersion_Good(t *testing.T) {
	...
	targetSymbol := "CDNSource LatestVersion"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestCdn_CDNSource_Download_Good(t *testing.T) {
	...
	targetSymbol := "CDNSource Download"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
