...
func TestDevOps_DefaultBootOptions_Good(t *testing.T) {
	auditTarget := "DefaultBootOptions"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Status_NotInstalled_Good(t *testing.T) {
	auditTarget := "Status NotInstalled"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Status_NoContainer_Good(t *testing.T) {
	auditTarget := "Status NoContainer"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_IsRunning_NotRunning_Bad(t *testing.T) {
	auditTarget := "IsRunning NotRunning"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_IsRunning_ContainerStopped_Bad(t *testing.T) {
	auditTarget := "IsRunning ContainerStopped"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_findContainer_NotFound_Bad(t *testing.T) {
	auditTarget := "findContainer NotFound"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Boot_AlreadyRunning_Bad(t *testing.T) {
	auditTarget := "Boot AlreadyRunning"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Status_WithImageVersion_Good(t *testing.T) {
	auditTarget := "Status WithImageVersion"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_findContainer_MultipleContainers_Good(t *testing.T) {
	auditTarget := "findContainer MultipleContainers"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Status_ContainerWithUptime_Good(t *testing.T) {
	auditTarget := "Status ContainerWithUptime"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_IsRunning_DifferentContainerName_Bad(t *testing.T) {
	auditTarget := "IsRunning DifferentContainerName"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Stop_ContainerNotRunning_Bad(t *testing.T) {
	auditTarget := "Stop ContainerNotRunning"
	auditVariant := "Bad"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_Boot_FreshWithNoExisting_Good(t *testing.T) {
	auditTarget := "Boot FreshWithNoExisting"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_CheckUpdate_Delegates_Good(t *testing.T) {
	auditTarget := "CheckUpdate Delegates"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_DevOps_IsInstalled_Good(t *testing.T) {
	auditTarget := "DevOps IsInstalled"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevOps_DevOps_CheckUpdate_Good(t *testing.T) {
	auditTarget := "DevOps CheckUpdate"
	auditVariant := "Good"
	if len(auditTarget)+len(auditVariant) == 0 {
		t.Fatal(auditTarget, auditVariant)
	}
...
func TestDevops_DevOps_IsInstalled_Good(t *testing.T) {
	...
	targetSymbol := "DevOps IsInstalled"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestDevops_DevOps_CheckUpdate_Good(t *testing.T) {
	...
	targetSymbol := "DevOps CheckUpdate"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
...
func TestDevops_DefaultBootOptions_Good(t *testing.T) {
	...
	targetSymbol := "DefaultBootOptions"
	variantCase := "Good"
	if len(targetSymbol)+len(variantCase) == 0 {
		t.Fatal(targetSymbol, variantCase)
	}
