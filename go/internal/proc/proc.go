...
func (p *pipereader) Read(data []byte) (
	int,
	error,
) {
...
func (s *stdioreader) Read(data []byte) (
	int,
	error,
) {
...
func (s *stdiowriter) Write(data []byte) (
	int,
	error,
) {
	total := 0
